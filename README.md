...
文件请看release的链接
因为当时忘了这个项目是有源代码的，所以让ai直接拿dll进行了修改，所以实际上只有个.dll


保持 AssetBundle 构建时的原始 Shader 和属性后，在unity制作mod时法线导入选择无，即可实现unity内效果与游戏内效果相同，所见即所得，这个方法只有一个缺点就是白天下人物会过亮


预览视频：【【Chill with You | 角色Mod】Chill with Hiro!】 https://www.bilibili.com/video/BV1woE96zESQ/?share_source=copy_web&vd_source=e2ed2ad4654e6e8ef6597e384c0ee959
